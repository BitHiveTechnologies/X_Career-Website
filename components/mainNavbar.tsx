    ...
    return (
        <div data-oid="abre74j">
            <header
                ...
                data-oid="5_8n7rd"
            >
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid="0wk4126">
                    <div className="flex justify-between items-center h-16" data-oid="aq54d1k">
                        {/* Logo */}
                        <div className="flex-shrink-0" data-oid="us2k348">
                            <a href="/" className="flex items-center" data-oid="wvb1zcs">
                                <Logo data-oid="fkbeudf" />
                            </a>
                        </div>

                        {/* Navigation Links - Hidden on mobile */}
                        <div className="hidden md:flex items-center space-x-4" data-oid="i71bbqu">
                            <a
                                href="/jobs"
                        ...
                        {/* Auth Buttons */}
                        <div className="flex items-center space-x-3" data-oid="as3o2nw">
                            <Link
                                href="/login"
                    ...
                    {mobileMenuOpen && (
                        <div className="md:hidden" data-oid="zualn8-">
                            <div
                            ...
                            >
                                ...
                                <div className="pt-2 space-y-2" data-oid="6z9lcxg">
                                    <Link
                                        href="/login"
