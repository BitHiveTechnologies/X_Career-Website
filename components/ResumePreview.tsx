                ...
                {exp.description.length > 0 && (
                  ...
                  >
                    {exp.description
                      ...
                      .map((desc, index) => (
                        <li key={index} className="text-sm" data-oid="somywil">
                          {desc}
                        </li>
                      ))}
                  </ul>
                  ...
                  >
                    {edu.achievements
                      ...
                      .map((achievement, index) => (
                        <li key={index} className="text-sm" data-oid="xq5-inc">
                          {achievement}
                        </li>
                      ))}
                  </ul>
            ...
            {resumeData.projects.map((project) => (
              <div key={project.id} data-oid="zifl683">
                <div className="mb-2" data-oid="n5ljv7c">
                  ...
                  >
                    {project.link && (
                      <span data-oid="0pei95n">Live Demo: {project.link}</span>
                    )}
                    {project.github && (
                ...
                {project.highlights.length > 0 && project.highlights[0] && (
                  ...
                  >
                    {project.highlights
                      ...
                      .map((highlight, index) => (
                        <li key={index} className="text-sm" data-oid="bnegmru">
                          {highlight}
                        </li>
                      ))}
                  </ul>
    ...
    >
      ...
      <header className="text-center mb-8" data-oid="ab_2fa-">
        ...
        >
          ...
          {resumeData.personalInfo.linkedin && (
            <span data-oid="kcrjpy:">LinkedIn</span>
          )}
          {resumeData.personalInfo.github && (
            <span data-oid="43.jj::">GitHub</span>
          )}
        </div>
      </header>
