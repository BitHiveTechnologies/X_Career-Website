...
export default function TemplateSelector({
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border p-6" data-oid="_3hl1de">
            <h2 className="text-xl font-semibold text-gray-800 mb-4" data-oid="k7rj2he">
                Choose Your Template
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4" data-oid="b7qx22n">
                {templates.map((template) => (
                    ...
                    >
                        ...
                        <div
                            ...
                            data-oid="-7k826t"
                        >
                            <div className="text-gray-400 text-center" data-oid="lq5i09i">
                                <svg
                                ...
                                <span className="text-xs" data-oid="m3marxu">
                                    Preview
                                </span>
                            </div>
                        </div>

                        <h3 className="font-semibold text-gray-800 mb-1" data-oid="eyorhyc">
                            {template.name}
                        </h3>
                        <p className="text-sm text-gray-600 mb-3" data-oid="ucnf8tq">
                            {template.description}
                        </p>

                        {/* Features */}
                        <div className="space-y-1" data-oid="6is5k:h">
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg" data-oid="epa_7gs">
                <div className="flex items-start space-x-3" data-oid="bjm3.7l">
                    <svg
                    ...
                    <div data-oid="76wxt_d">
                        <h4 className="font-medium text-blue-800 mb-1" data-oid="eql7r-7">
                            Template Tips
                        </h4>
                        <ul className="text-sm text-blue-700 space-y-1" data-oid="3zauni_">
                            <li data-oid="apq0xhu">
                                • All templates are ATS-friendly and optimized for applicant
                                tracking systems
                            </li>
                            <li data-oid="thr._9s">
                                • Choose based on your industry: Modern for tech, Minimal for any
                                field
                            </li>
                            <li data-oid="5yyn2sy">
