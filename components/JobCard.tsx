        ...
        >
            ...
            >
                {job.isUrgent && (
                    ...
                    >
                        🔥{' '}
                        <span className="hidden sm:inline" data-oid="7.vt-8d">
                            URGENT HIRING
                        </span>
                    </span>
                )}
                {job.isFeatured && (
                    ...
                    >
                        ⭐{' '}
                        <span className="hidden sm:inline" data-oid="5igznep">
                            FEATURED
                        </span>
                    </span>
                )}
            ...
            {/* Remote Badge */}
            {job.isRemote && (
                <div className="absolute top-3 left-3 sm:top-4 sm:left-4 z-10" data-oid="9lypwo2">
                    <span
            ...
            {/* Header Section */}
            <div className="mb-4 sm:mb-6 mt-8 sm:mt-0" data-oid=".71p77x">
                <div className="flex items-start justify-between mb-3" data-oid="4eclnp-">
                    <div className="flex-1 min-w-0 pr-2" data-oid="889g:p4">
                        <h3
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-2" data-oid="zb15pei">
                            <p
                        ...
                        {job.industry && (
                            <p className="text-sm text-gray-600 truncate" data-oid="-e70v3s">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-4" data-oid="32b2d-f">
                    {job.salary && (
                        <div className="flex items-center gap-1" data-oid=":.2nhnz">
                            <div className="flex items-center gap-1" data-oid="nruh85:">
                                <svg
                    ...
                    {job.applicantCount && (
                        ...
                        >
                            👥 {job.applicantCount}{' '}
                            <span className="hidden sm:inline" data-oid="ykz1a0_">
                                applicants
                            </span>
                        </span>
                    )}
            ...
            {/* Details Row */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4" data-oid="fjpe.:7">
                <div className="flex items-center text-gray-600" data-oid="fncf.6k">
                    <svg
                    ...
                    <span className="text-sm truncate" data-oid="_b7xtb1">
                        <span className="font-medium" data-oid="kos3--d">
                            Location:
                        </span>{' '}
                        {job.location}
                    </span>
                </div>
                <div className="flex items-center text-gray-600" data-oid="p.eajn9">
                    <svg
                        className="h-4 w-4 mr-2 text-[hsl(196,80%,45%)] flex-shrink-0"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="text-sm truncate" data-oid="f0-utdy">
                        <span className="font-medium" data-oid="n6hrd.q">
                            Experience:
                        </span>{' '}
            ...
            <div className="flex flex-wrap gap-2 mb-4" data-oid="9qi2ffo">
                <span
            ...
            {job.benefits && job.benefits.length > 0 && (
                <div className="mb-4" data-oid="w4uaawz">
                    <div className="flex items-center mb-2" data-oid="my9w0oi">
                        <svg
                            className="h-4 w-4 mr-2 text-[hsl(196,80%,45%)] flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                        ...
                        <span className="text-sm font-medium text-gray-700" data-oid="zoedup2">
                            Benefits:
                        </span>
                    </div>
                    <div className="flex flex-wrap gap-1" data-oid="tz1tq8g">
                        ...
                        {job.benefits.length > 3 && (
                            <span className="text-xs text-gray-500 px-2 py-1" data-oid="d8nrhzt">
            ...
            <div
                ...
                data-oid="7fp7_eo"
            >
                <div className="flex-1 min-w-0" data-oid="dr.esz6">
                    <div className="flex items-center text-gray-600 mb-2" data-oid="10.b3-z">
                        <svg
                            className="h-4 w-4 mr-2 text-[hsl(196,80%,45%)] flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                        ...
                        <span className="text-sm" data-oid="qm.6_xf">
                            <span className="font-medium" data-oid="0cqh:3c">
                                Posted:
                            </span>{' '}
                    ...
                    <div className="flex items-start" data-oid="ih1s-r7">
                        <svg
                        ...
                        <div className="flex-1 min-w-0" data-oid="fpdq7dd">
                            <span className="text-sm font-medium text-gray-700" data-oid="wokwi9f">
                                Skills Required:
                            </span>
                            <div className="flex flex-wrap gap-1 mt-1" data-oid=".crbfwp">
                ...
                >
                    ...
                    >
                        ...
                        <span className="truncate" data-oid="_:h.iu-">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="hidden sm:inline" data-oid="ftq17j6">
                                View Details
                            </span>
                        </button>
