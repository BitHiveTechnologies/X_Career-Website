...
export default function JobCard({ job, viewMode = 'list' }: JobCardProps) {
    ...
    return (
        ...
        >
            {/* Badges Container */}
            <div className="absolute top-4 right-4 flex flex-col gap-2" data-oid="s1_2jq6">
                {/* Urgent Hiring Badge */}
                {job.isUrgent && (
                    <span
            ...
            {/* Remote Badge */}
            {job.isRemote && (
                <div className="absolute top-4 left-4" data-oid=".1x3vr4">
                    <span
            ...
            {/* Header Section */}
            <div className="mb-6" data-oid="gjq8mwu">
                <div className="flex items-start justify-between mb-3" data-oid="spb._d0">
                    <div className="flex-1 min-w-0" data-oid="8tatc0l">
                        <h3
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-2" data-oid="_svlhjm">
                            <p
                        ...
                        {job.industry && (
                            <p className="text-sm text-gray-600" data-oid="3:hdshv">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-4" data-oid="5ioqg9x">
                    {job.salary && (
                        <div className="flex items-center gap-1" data-oid="bg52xvp">
                            <span className="text-green-600 font-medium text-sm" data-oid="5bovofj">
                                💰 {job.salary}
                            </span>
                        </div>
                    )}
            ...
            {/* Details Row */}
            <div className="grid md:grid-cols-2 gap-4 mb-4" data-oid="e_7wuvx">
                <div className="flex items-center text-gray-600" data-oid="edukvxa">
                    <svg
                    ...
                    <span className="text-sm" data-oid="7hxgtf1">
                        <span className="font-medium" data-oid="juth8wv">
                            Location:
                        </span>{' '}
                        {job.location}
                    </span>
                </div>
                <div className="flex items-center text-gray-600" data-oid="rp1xsc6">
                    <svg
                        className="h-4 w-4 mr-2 text-[hsl(196,80%,45%)]"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="text-sm" data-oid="w886ie5">
                        <span className="font-medium" data-oid="nb2nlv4">
                            Experience:
                        </span>{' '}
            ...
            <div className="flex flex-wrap gap-2 mb-4" data-oid="v6em7:r">
                <span
            ...
            {job.benefits && job.benefits.length > 0 && (
                <div className="mb-4" data-oid="lcpfwxc">
                    <div className="flex items-center mb-2" data-oid="smi:qvp">
                        <svg
                            className="h-4 w-4 mr-2 text-[hsl(196,80%,45%)]"
                            fill="none"
                            stroke="currentColor"
                        ...
                        <span className="text-sm font-medium text-gray-700" data-oid="jbk3uov">
                            Benefits:
                        </span>
                    </div>
                    <div className="flex flex-wrap gap-1" data-oid="iulozvx">
                        ...
                        {job.benefits.length > 3 && (
                            <span className="text-xs text-gray-500 px-2 py-1" data-oid="5amztju">
            ...
            {/* Footer Row */}
            <div className="flex justify-between items-end" data-oid="i985lq7">
                <div className="flex-1" data-oid="a.q-use">
                    <div className="flex items-center text-gray-600 mb-2" data-oid="ks44s.c">
                        <svg
                            className="h-4 w-4 mr-2 text-[hsl(196,80%,45%)]"
                            fill="none"
                            stroke="currentColor"
                        ...
                        <span className="text-sm" data-oid="lla5d7f">
                            <span className="font-medium" data-oid="ns:b_52">
                                Posted:
                            </span>{' '}
                    ...
                    <div className="flex items-start" data-oid="5x.6cb9">
                        <svg
                        ...
                        <div className="flex-1" data-oid="e.eb.ln">
                            <span className="text-sm font-medium text-gray-700" data-oid="v0qng_2">
                                Skills Required:
                            </span>
                            <div className="flex flex-wrap gap-1 mt-1" data-oid="zoxthyl">
