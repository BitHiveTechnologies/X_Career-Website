        ...
        >
            ...
            >
                ...
                <div
                    ...
                    data-oid="k86h2uh"
                >
                    <div className="flex items-center justify-between" data-oid="33y:csh">
                        <div data-oid="pthdlbk">
                            <h1 className="text-2xl font-bold" data-oid="pkkvgvd">
                                Quick Apply
                            </h1>
                            <p className="text-blue-100" data-oid="iyq6045">
                ...
                {/* Form */}
                <form onSubmit={handleSubmit} className="p-6 space-y-6" data-oid="8bd6r_q">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6" data-oid=":i83:4j">
                        <div data-oid="8_7u_rr">
                            <label
                            ...
                            {errors.fullName && (
                                <p className="text-red-500 text-sm mt-1" data-oid="7v87zxs">
                                    {errors.fullName}
                                </p>
                            )}
                        </div>

                        <div data-oid="0fb7s03">
                            <label
                                className="block text-sm font-medium text-gray-700 mb-2"
                                data-oid="gf3d0lz"
                            >
                            ...
                            {errors.email && (
                                <p className="text-red-500 text-sm mt-1" data-oid="w9a26q.">
                                    {errors.email}
                                </p>
                            )}
                        </div>
                    ...
                    <div data-oid="4k8x4nt">
                        ...
                        {errors.phone && (
                            <p className="text-red-500 text-sm mt-1" data-oid="t:pgrmh">
                                {errors.phone}
                            </p>
                        )}
                    </div>

                    <div data-oid="ap62c-0">
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2"
                            data-oid="lq6:1wv"
                        >
                        ...
                        >
                            ...
                            <label
                                ...
                                data-oid="l_81pl:"
                            >
                                <div className="text-gray-600" data-oid="u0d_ku.">
                                    <svg
                                    ...
                                    <p className="mt-2 text-sm" data-oid="wxxrpco">
                                        <span
                                    ...
                                    <p className="text-xs text-gray-500" data-oid="69rk9ue">
                                        PDF, DOC, DOCX up to 10MB
                                    </p>
                                </div>
                            </label>
                            {formData.resume && (
                                <p className="mt-2 text-sm text-green-600" data-oid="7728z3c">
                                    ✓ {formData.resume.name}
                                </p>
                            )}
                        </div>
                        {errors.resume && (
                            <p className="text-red-500 text-sm mt-1" data-oid="qjsijhp">
                                {errors.resume}
                            </p>
                        )}
                    </div>

                    <div data-oid="10p9lbu">
                        <label
                            className="block text-sm font-medium text-gray-700 mb-2"
                            data-oid="2t2i4_j"
                        >
