...
export function ChartAreaInteractive({ data = [] }: { data?: { date: string; customers: number }[] }) {
  ...
  const filteredData = chartData.filter((item) => {
    ...
    const referenceDate = data.length > 0 ? new Date(data[data.length - 1].date) : new Date("2024-06-30")
