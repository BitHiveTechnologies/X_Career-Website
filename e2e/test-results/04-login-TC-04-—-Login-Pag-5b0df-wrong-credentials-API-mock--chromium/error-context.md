...
- Name: 04-login.spec.ts >> TC-04 — Login Page >> should show error for wrong credentials (API mock)
- Location: e2e/tests/04-login.spec.ts:89:7
...
```ts
  ...
  4   | 
  5   | /** Mock the login API to return a valid user + tokens */
  6   | async function mockLoginSuccess(page: Page, email = 'qa@example.com') {
  ...
  12  |         success: true,
  13  |         data: {
  14  |           accessToken: 'mock_access_token_e2e',
  15  |           refreshToken: 'mock_refresh_token_e2e',
  16  |           user: {
  17  |             id: 'user_e2e_login',
  18  |             email,
  19  |             role: 'user',
  20  |             firstName: 'QA',
  21  |             lastName: 'Tester'
