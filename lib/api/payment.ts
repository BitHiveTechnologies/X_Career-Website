...
class PaymentService {
    ...
    async getSubscriptionPlans(): Promise<SubscriptionPlansResponse> {
        try {
            const response = await fetch(
                `${this.baseUrl}/api/${this.apiVersion}/subscriptions/plans`,
            );
    ...
    async getCurrentSubscription(): Promise<CurrentSubscriptionResponse> {
        try {
            const response = await fetch(
                `${this.baseUrl}/api/${this.apiVersion}/subscriptions/current`,
                {
    ...
    async createOrder(request: CreateOrderRequest): Promise<CreateOrderResponse> {
        try {
            const response = await fetch(
                `${this.baseUrl}/api/${this.apiVersion}/payments/create-order`,
                {
                    method: 'POST',
                    headers: this.getAuthHeaders(),
    ...
    async getPaymentHistory(): Promise<PaymentHistoryResponse> {
        try {
            const response = await fetch(
                `${this.baseUrl}/api/${this.apiVersion}/payments/history`,
                {
                    headers: this.getAuthHeaders(),
                },
            );
    ...
    async getPaymentStatus(referenceId: string): Promise<VerifyPaymentResponse> {
        try {
            const response = await fetch(
                `${this.baseUrl}/api/${this.apiVersion}/payments/status/${encodeURIComponent(referenceId)}`,
                {
                    headers: this.getAuthHeaders(),
                },
            );
