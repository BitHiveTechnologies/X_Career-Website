...
export const metadata: Metadata = {
            title: 'Join X Careers Telegram Community | Tech Professionals Network',
    description:
    ...
    openGraph: {
        title: 'Join X Careers Telegram Community',
        description: 'Connect with 2,700+ tech professionals and get curated job updates',
        type: 'website',
    },
    twitter: {
