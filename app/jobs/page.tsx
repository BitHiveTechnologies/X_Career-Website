...
const mockJobs: Job[] = [
  ...
  },
  {
    ...
    salary: "₹10-18 LPA",
    description:
      "Analyze data to drive business decisions for e-commerce platform...",
    isRemote: true,
    isFeatured: false,
    isUrgent: false,
    applicantCount: 312,
  ...
  },
  {
    ...
    salary: "₹5-9 LPA",
    description:
      "Design beautiful and intuitive user experiences for mobility platform...",
    isRemote: false,
    isFeatured: false,
    isUrgent: false,
    applicantCount: 167,
  ...
  },
  {
    ...
    salary: "₹15-25 LPA",
    description:
      "Manage and optimize cloud infrastructure for digital payments...",
    isRemote: true,
    isFeatured: true,
    isUrgent: true,
    applicantCount: 89,
  ...
  },
  {
    ...
    salary: "₹8-14 LPA",
    description:
      "Build engaging mobile experiences for fantasy sports platform...",
    isRemote: false,
    isFeatured: false,
    isUrgent: false,
    applicantCount: 278,
  ...
  },
  {
    ...
    salary: "₹20-35 LPA",
    description:
      "Build AI-powered recommendation systems for streaming platform...",
    isRemote: false,
    isFeatured: true,
    isUrgent: true,
    applicantCount: 123,
  ...
  },
  {
    ...
    salary: "₹12-20 LPA",
    description:
      "Secure payment infrastructure and protect against cyber threats...",
    isRemote: true,
    isFeatured: false,
    isUrgent: false,
    applicantCount: 156,
  ...
  },
  {
    ...
    salary: "₹25-40 LPA",
    description:
      "Lead product development for educational technology platform...",
    isRemote: false,
    isFeatured: false,
    isUrgent: false,
    applicantCount: 89,
...
export default function JobsPage() {
  ...
  useEffect(() => {
    ...
    if (filters.experienceLevel) {
      filtered = filtered.filter(
        (job) => job.experienceRequired === filters.experienceLevel,
      );
    }
    ...
    if (filters.companyType) {
      filtered = filtered.filter(
        (job) => job.companyType === filters.companyType,
      );
    }
