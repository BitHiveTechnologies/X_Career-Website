...
export default function JobDetailsPage() {
    ...
    if (!job) {
        return (
            <>
                <MainNavbar data-oid="oysx:l2" />
                <div
                    className="min-h-screen bg-gradient-to-b from-[hsl(196,60%,95%)] to-white flex items-center justify-center"
                    data-oid="-.dv-1."
                >
                    <div className="text-center" data-oid="n6.-hv.">
                        <h1 className="text-2xl font-bold text-gray-800 mb-4" data-oid="zz:p8e7">
                            Job Not Found
                        </h1>
                        <p className="text-gray-600 mb-6" data-oid="i1.icwi">
        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    data-oid="umvvk26"
                >
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4" data-oid="oy7pnin">
                        <nav
                        ...
                        >
                            ...
                            <span data-oid="6xe8owg">›</span>
                            <span className="text-gray-800 font-medium" data-oid="88ak1d-">
                                {job.title}
                            </span>
                        </nav>
                    </div>
                ...
                >
                    ...
                    >
                        <div
                            ...
                            data-oid="wuapn86"
                        >
                            <div className="flex-1" data-oid="850t1dg">
                                <div className="flex items-center gap-4 mb-4" data-oid="exe0d_d">
                                    <div
                                    ...
                                    <div data-oid="zm4mv9c">
                                        ...
                                        <p className="text-xl text-blue-100" data-oid="yjiks1n">
                                            {job.company}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    data-oid="zkwse3i"
                                >
                                    <div className="flex items-center gap-2" data-oid="u41s6-x">
                                        <svg
                                            className="h-5 w-5"
                                            fill="none"
                                            stroke="currentColor"
                                        ...
                                        <span data-oid="_5mxifh">{job.location}</span>
                                    </div>
                                    <div className="flex items-center gap-2" data-oid="uj5n65b">
                                        <svg
                                            className="h-5 w-5"
                                            fill="none"
                                            stroke="currentColor"
                                        ...
                                        <span data-oid="hkrqxg_">{job.salary}</span>
                                    </div>
                                    <div className="flex items-center gap-2" data-oid="dakarn_">
                                        <svg
                                            className="h-5 w-5"
                                            fill="none"
                                            stroke="currentColor"
                                        ...
                                        <span data-oid="2ifpxxu">{job.experienceRequired}</span>
                                    </div>
                                    <div className="flex items-center gap-2" data-oid="pmj70ir">
                                        <svg
                                            className="h-5 w-5"
                                            fill="none"
                                            stroke="currentColor"
                                        ...
                                        <span data-oid="40b29:y">
                                            Posted {formatDate(job.postedDate)}
                                        </span>
                                    </div>
                                </div>

                                <div className="flex flex-wrap gap-3" data-oid="-gme64r">
                                    {job.isUrgent && (
                                        <span
                            ...
                            >
                                ...
                                <div className="flex gap-3" data-oid="14_zp2_">
                                    <button
                                        onClick={handleSave}
                ...
                <div
                    ...
                    data-oid=".p.6lla"
                >
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6" data-oid="-a7933_">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6" data-oid="esqgbsj">
                            <div className="text-center" data-oid="ukpef4f">
                                <div
                                ...
                                <div className="text-sm text-gray-600" data-oid="_74:uax">
                                    Applicants
                                </div>
                            </div>
                            <div className="text-center" data-oid="utsrwks">
                                <div
                                ...
                                <div className="text-sm text-gray-600" data-oid="jxof28w">
                                    Company Size
                                </div>
                            </div>
                            <div className="text-center" data-oid="hzpxwm-">
                                <div
                                ...
                                <div className="text-sm text-gray-600" data-oid=".jsfy--">
                                    Industry
                                </div>
                            </div>
                            <div className="text-center" data-oid="0y02jib">
                                <div
                                ...
                                <div className="text-sm text-gray-600" data-oid="ts61cqg">
                ...
                {/* Main Content */}
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-oid="s7msq2:">
                    <div className="grid lg:grid-cols-3 gap-8" data-oid="8_g01ep">
                        {/* Main Content */}
                        <div className="lg:col-span-2" data-oid=".:hhmts">
                            {/* Tabs */}
                            <div
                                className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md border border-gray-200 mb-8"
                                data-oid="5dn.f0m"
                            >
                                <div className="border-b border-gray-200" data-oid="6qq753p">
                                    <nav className="flex space-x-8 px-6" data-oid="sul5e92">
                                        {[
                                ...
                                <div className="p-6" data-oid="bd72ipk">
                                    {activeTab === 'overview' && (
                                        <div className="space-y-6" data-oid="nhn65d1">
                                            <div data-oid="17bk5wp">
                                                <h3
                                            ...
                                            <div data-oid="1n0l:yk">
                                                ...
                                                <ul className="space-y-2" data-oid="8c-ah8j">
                                                    <li
                                    ...
                                    {activeTab === 'requirements' && (
                                        <div className="space-y-6" data-oid="halls50">
                                            <div data-oid="144z-y5">
                                                <h3
                                                    className="text-lg font-semibold text-gray-800 mb-3"
                                                    data-oid="noe:hj-"
                                                >
                                            ...
                                            <div data-oid="kb_qeg1">
                                                ...
                                                <ul className="space-y-3" data-oid="esvlyef">
                                                    <li
                                                        className="flex items-start gap-3"
                                                        data-oid="xpxhdgy"
                                                    >
                                    ...
                                    {activeTab === 'company' && (
                                        <div className="space-y-6" data-oid=".cvt341">
                                            <div data-oid="_t4ahug">
                                                <h3
                                                    className="text-lg font-semibold text-gray-800 mb-3"
                                                    data-oid="vv47bfd"
                                                >
                                    ...
                                    {activeTab === 'reviews' && (
                                        <div className="space-y-6" data-oid="c71fn:2">
                                            <div className="text-center py-8" data-oid="42u85a3">
                                                <div className="text-6xl mb-4" data-oid="kbj9k4.">
                                                    ⭐
                                                </div>
                                                <h3
                                            ...
                                            <div className="space-y-4" data-oid="p.m-na3">
                                                {[
                                                    {
                                                        rating: 5,
                        ...
                        {/* Sidebar */}
                        <div className="lg:col-span-1" data-oid="tnug12j">
                            <div className="sticky top-24 space-y-6" data-oid="-5htmww">
                                {/* Apply Card */}
                                <div
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        data-oid="b2:cyes"
                                    >
                                        <div className="flex items-center gap-2" data-oid="tu96lrn">
                                            <svg
                                            ...
                                            <span data-oid="pxcubwl">
                                                Quick application process
                                            </span>
                                        </div>
                                        <div className="flex items-center gap-2" data-oid="1n8r1cy">
                                            <svg
                                                className="h-4 w-4 text-green-500"
                                                fill="none"
                                                stroke="currentColor"
                                            ...
                                            <span data-oid="6aysych">Response within 3-5 days</span>
                                        </div>
                                        <div className="flex items-center gap-2" data-oid="upbvsab">
                                            <svg
                                                className="h-4 w-4 text-green-500"
                                                fill="none"
                                                stroke="currentColor"
                                            ...
                                            <span data-oid="g8-myt_">Direct contact with HR</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-3 text-sm" data-oid="vxk2k2h">
                                        <div className="flex justify-between" data-oid="2w.5ly2">
                                            <span className="text-gray-600" data-oid="dc79ek-">
                                                Job Type:
                                            </span>
                                            <span className="font-medium" data-oid="j3:i9op">
                                                {job.jobType}
                                            </span>
                                        </div>
                                        <div className="flex justify-between" data-oid="-he.6ua">
                                            <span className="text-gray-600" data-oid="jzfvn3u">
                                                Employment:
                                            </span>
                                            <span className="font-medium" data-oid="_v_muz5">
                                                {job.employmentType}
                                            </span>
                                        </div>
                                        <div className="flex justify-between" data-oid="emoon56">
                                            <span className="text-gray-600" data-oid="c25m_dz">
                                                Experience:
                                            </span>
                                            <span className="font-medium" data-oid="fa-5ll_">
                                                {job.experienceRequired}
                                            </span>
                                        </div>
                                        <div className="flex justify-between" data-oid="pz49jac">
                                            <span className="text-gray-600" data-oid="r.m3wc1">
                                                Salary:
                                            </span>
                                            <span className="font-medium" data-oid="68n.vrk">
                                                {job.salary}
                                            </span>
                                        </div>
                                        <div className="flex justify-between" data-oid=":rg1m-g">
                                            <span className="text-gray-600" data-oid="v2m6qsa">
                                                Location:
                                            </span>
                                            <span className="font-medium" data-oid="cufbku0">
                                                {job.location}
                                            </span>
                                        </div>
                                        <div className="flex justify-between" data-oid="wz89v5y">
                                            <span className="text-gray-600" data-oid="_j.k.kk">
                                                Remote:
                                            </span>
                                            <span className="font-medium" data-oid=":vt9krl">
                                                {job.isRemote ? 'Yes' : 'No'}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-3" data-oid="4kliv-2">
                                        {[
                                            {
                ...
                <div className="fixed bottom-6 right-6 z-50 lg:hidden" data-oid="he35w1_">
                    <button
                        onClick={handleApply}
