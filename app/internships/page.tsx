...
export default function InternshipsPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 font-sans" data-oid="w9px43u">
            {/* Navbar */}
            <MainNavbar data-oid="o4.:nnd" />
            ...
            >
                ...
                <div className="absolute inset-0 overflow-hidden" data-oid="8cs.r7s">
                    <div
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl mb-2 text-blue-100" data-oid="o524v3i">
                        Launch Your Career Journey
                    </p>
                    <p className="text-lg text-blue-200 max-w-2xl mx-auto mb-8" data-oid="xhkc25b">
                        Discover thousands of internship opportunities from top Indian companies
                    </p>

                    {/* Advanced Search Bar */}
                    <form onSubmit={handleSearch} className="max-w-4xl mx-auto" data-oid="afp5x0t">
                        <div
                            className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"
                            data-oid="98g0ocr"
                        >
                            <div className="grid md:grid-cols-3 gap-4" data-oid="k2gjm1g">
                                {/* Internship Title Search */}
                                <div className="relative" data-oid="ra_iiuy">
                                    <div
                                ...
                                {/* Location Search */}
                                <div className="relative" data-oid="9g3449a">
                                    <div
                                        className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"
                                        data-oid="v-_6ino"
                                    >
            ...
            <section
                ...
                data-oid="6pp1o-d"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid="f-nmvqn">
                    <CategoryMenu
                    ...
                    <div className="text-center mt-6" data-oid="-vel_nk">
                        <div
                        ...
                        >
                            ...
                            <span className="text-lg font-bold text-gray-800" data-oid="ybuk09o">
            ...
            <section
                ...
                data-oid="lvdxfp6"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid="c8qbf6g">
                    <div className="grid lg:grid-cols-4 gap-8" data-oid="l6vz46o">
                        {/* Filters Sidebar */}
                        <div className="lg:col-span-1 order-2 lg:order-1" data-oid=":fc_c6l">
                            <FiltersSidebar
                                filters={filters}
                        ...
                        {/* Internship Listings */}
                        <div className="lg:col-span-3 order-1 lg:order-2" data-oid="8-yc3ip">
                            {/* Toolbar */}
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {/* Sort Options */}
                                        <div className="flex items-center gap-2" data-oid="8a:jme.">
                                            <label
                                            ...
                                            <select
                                                ...
                                                data-oid=".1et70u"
                                            >
                                                <option value="relevance" data-oid="kh4vw3o">
                                                    Relevance
                                                </option>
                                                <option value="date" data-oid="x7nj6vg">
                                                    Date Posted
                                                </option>
                                                <option value="stipend" data-oid="ghypvlp">
                                                    Stipend
                                                </option>
                                                <option value="duration" data-oid="saip8.4">
                                                    Duration
                                                </option>
                                                <option value="company" data-oid="7got3q7">
                                                    Company
                                                </option>
                                            </select>
                                        </div>
                            ...
                            >
                                <div
                                    ...
                                    data-oid="naodlo:"
                                >
                                    <div className="flex items-start gap-4" data-oid=":zd3w_m">
                                        <div
                                        ...
                                        <div data-oid="d364iwq">
                                            ...
                                            <p className="text-gray-600 text-sm" data-oid="udo4qzb">
                            ...
                            <div className="space-y-6" data-oid="p:_zgju">
                                {isLoading ? (
                                    <div className="text-center py-16" data-oid="2i-8k0u">
                                        <div
                                            className="animate-spin rounded-full h-12 w-12 border-b-2 border-[hsl(196,80%,45%)] mx-auto"
                                            data-oid="juqsptx"
                                        ></div>
                                        <p className="mt-4 text-gray-600" data-oid="8nc0v53">
                                            Loading internships...
                                        </p>
                                    </div>
                                    ...
                                    <>
                                        ...
                                        {visibleInternships < filteredInternships.length && (
                                            <div className="text-center py-8" data-oid="6cqkilt">
                                                <button
                                    ...
                                    <div className="text-center py-16" data-oid="0siofk.">
                                        <div
                                        ...
                                        <p className="text-gray-600 mb-6" data-oid=":hiln1g">
