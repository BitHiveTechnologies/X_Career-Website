...
export default function InternshipsPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 font-sans" data-oid=".c9uedj">
            {/* Navbar */}
            <MainNavbar data-oid="un3x412" />
            ...
            >
                ...
                <div className="absolute inset-0 overflow-hidden" data-oid="87hcr7m">
                    <div
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl mb-2 text-blue-100" data-oid="28ge530">
                        Launch Your Career Journey
                    </p>
                    <p className="text-lg text-blue-200 max-w-2xl mx-auto mb-8" data-oid="8p1hvqq">
                        Discover thousands of internship opportunities from top Indian companies
                    </p>

                    {/* Advanced Search Bar */}
                    <form onSubmit={handleSearch} className="max-w-4xl mx-auto" data-oid=".fmrvgk">
                        <div
                            className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"
                            data-oid="s5pai5p"
                        >
                            <div className="grid md:grid-cols-3 gap-4" data-oid="m1:_7:o">
                                {/* Internship Title Search */}
                                <div className="relative" data-oid="td2.-bn">
                                    <div
                                ...
                                {/* Location Search */}
                                <div className="relative" data-oid=".p5pak1">
                                    <div
                                        className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"
                                        data-oid="2ns3qfz"
                                    >
            ...
            <section
                ...
                data-oid="xxpv:xu"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid="850bmin">
                    <CategoryMenu
                    ...
                    <div className="text-center mt-6" data-oid="ik9z4i-">
                        <div
                        ...
                        >
                            ...
                            <span className="text-lg font-bold text-gray-800" data-oid="r83g.e_">
            ...
            <section
                ...
                data-oid="rvl58bv"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid=".:8wx59">
                    <div className="grid lg:grid-cols-4 gap-8" data-oid="gf0guhu">
                        {/* Filters Sidebar */}
                        <div className="lg:col-span-1 order-2 lg:order-1" data-oid="l.hy1t4">
                            <FiltersSidebar
                                filters={filters}
                        ...
                        {/* Internship Listings */}
                        <div className="lg:col-span-3 order-1 lg:order-2" data-oid="1k92pv8">
                            {/* Toolbar */}
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {/* Sort Options */}
                                        <div className="flex items-center gap-2" data-oid="3bwd3wv">
                                            <label
                                            ...
                                            <select
                                                ...
                                                data-oid="cz0m2cf"
                                            >
                                                <option value="relevance" data-oid="e7n9g5u">
                                                    Relevance
                                                </option>
                                                <option value="date" data-oid="a4lzvql">
                                                    Date Posted
                                                </option>
                                                <option value="stipend" data-oid="7k8wnes">
                                                    Stipend
                                                </option>
                                                <option value="duration" data-oid="ftuvyiz">
                                                    Duration
                                                </option>
                                                <option value="company" data-oid="e8:mqvh">
                                                    Company
                                                </option>
                                            </select>
                                        </div>
                            ...
                            >
                                <div
                                    ...
                                    data-oid="v_50.t5"
                                >
                                    <div className="flex items-start gap-4" data-oid="04.g9af">
                                        <div
                                        ...
                                        <div data-oid="5253jq-">
                                            ...
                                            <p className="text-gray-600 text-sm" data-oid="-1unm7s">
                            ...
                            <div className="space-y-6" data-oid="iwtrlcr">
                                {isLoading ? (
                                    <div className="text-center py-16" data-oid="zxl4pxs">
                                        <div
                                            className="animate-spin rounded-full h-12 w-12 border-b-2 border-[hsl(196,80%,45%)] mx-auto"
                                            data-oid="h3oizc."
                                        ></div>
                                        <p className="mt-4 text-gray-600" data-oid="u6nx73-">
                                            Loading internships...
                                        </p>
                                    </div>
                                    ...
                                    <>
                                        ...
                                        {visibleInternships < filteredInternships.length && (
                                            <div className="text-center py-8" data-oid="e_mscyp">
                                                <button
                                    ...
                                    <div className="text-center py-16" data-oid="u6604_8">
                                        <div
                                        ...
                                        <p className="text-gray-600 mb-6" data-oid="b66uobb">
