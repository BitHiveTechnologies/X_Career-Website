...
export const mockInternships: Internship[] = [
    ...
    },
    {
        ...
        description: 'Build scalable backend services for restaurant discovery platform...',
        isRemote: true,
        isFeatured: true,
        isUrgent: false,
        applicantCount: 203,
    ...
    },
    {
        ...
        description: 'Analyze customer data to improve recommendation systems...',
        isRemote: false,
        isFeatured: false,
        isUrgent: true,
        applicantCount: 289,
    ...
    },
    {
        ...
        description: 'Design intuitive user experiences for mobility solutions...',
        isRemote: false,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 134,
    ...
    },
    {
        ...
        description: 'Develop mobile features for fantasy sports platform...',
        isRemote: false,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 178,
    ...
    },
    {
        ...
        description: 'Learn cloud infrastructure management for fintech platform...',
        isRemote: true,
        isFeatured: true,
        isUrgent: true,
        applicantCount: 92,
    ...
    },
    {
        ...
        description: 'Create engaging educational content for learning platform...',
        isRemote: true,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 245,
    ...
    },
    {
        ...
        description: 'Drive user acquisition campaigns for fintech products...',
        isRemote: false,
        isFeatured: false,
        isUrgent: true,
        applicantCount: 167,
    ...
    },
    {
        ...
        description: 'Research and develop AI models for content recommendation...',
        isRemote: false,
        isFeatured: true,
        isUrgent: false,
        applicantCount: 78,
    ...
    },
    {
        ...
        description: 'Learn security practices for payment infrastructure...',
        isRemote: true,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 89,
    ...
    },
    {
        ...
        description: 'Support product development for SaaS platform...',
        isRemote: true,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 123,
    ...
    },
    {
        ...
        description: 'Develop blockchain solutions for crypto exchange...',
        isRemote: true,
        isFeatured: true,
        isUrgent: false,
        applicantCount: 45,
    ...
    },
    {
        ...
        description: 'Ensure quality of fashion e-commerce platform...',
        isRemote: false,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 156,
    ...
    },
    {
        ...
        description: 'Analyze business metrics for home services platform...',
        isRemote: false,
        isFeatured: false,
        isUrgent: true,
        applicantCount: 198,
    ...
    },
    {
        ...
        description: 'Support talent acquisition for beauty e-commerce platform...',
        isRemote: false,
        isFeatured: false,
        isUrgent: false,
        applicantCount: 234,
...
export default function InternshipsPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 font-sans" data-oid="pm4b7be">
            {/* Navbar */}
            <MainNavbar data-oid="qj0s8vm" />
            ...
            >
                ...
                <div className="absolute inset-0 overflow-hidden" data-oid=".v4hr:3">
                    <div
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl mb-2 text-blue-100" data-oid="yt9kiw3">
                        Launch Your Career Journey
                    </p>
                    <p className="text-lg text-blue-200 max-w-2xl mx-auto mb-8" data-oid="71u-cis">
                        Discover thousands of internship opportunities from top Indian companies
                    </p>

                    {/* Advanced Search Bar */}
                    <form onSubmit={handleSearch} className="max-w-4xl mx-auto" data-oid="8ikko.h">
                        <div
                            className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"
                            data-oid="nkmkhn8"
                        >
                            <div className="grid md:grid-cols-3 gap-4" data-oid="n9_l3zw">
                                {/* Internship Title Search */}
                                <div className="relative" data-oid="4p.dg-f">
                                    <div
                                ...
                                {/* Location Search */}
                                <div className="relative" data-oid="_83p3ll">
                                    <div
                                        className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"
                                        data-oid="e.7i5wq"
                                    >
            ...
            <section
                ...
                data-oid="3vx44z3"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid="o.h:ah1">
                    <CategoryMenu
                    ...
                    <div className="text-center mt-6" data-oid="gqiq488">
                        <div
                        ...
                        >
                            ...
                            <span className="text-lg font-bold text-gray-800" data-oid="qdzo_o:">
            ...
            <section
                ...
                data-oid="yka5rpl"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-oid=".ex_-3h">
                    <div className="grid lg:grid-cols-4 gap-8" data-oid="k78v7u3">
                        {/* Filters Sidebar */}
                        <div className="lg:col-span-1 order-2 lg:order-1" data-oid="8edddex">
                            <FiltersSidebar
                                filters={filters}
                        ...
                        {/* Internship Listings */}
                        <div className="lg:col-span-3 order-1 lg:order-2" data-oid="j.jgyjt">
                            {/* Toolbar */}
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {/* Sort Options */}
                                        <div className="flex items-center gap-2" data-oid="clxezrh">
                                            <label
                                            ...
                                            <select
                                                ...
                                                data-oid="ec-c5kd"
                                            >
                                                <option value="relevance" data-oid="c68kkbv">
                                                    Relevance
                                                </option>
                                                <option value="date" data-oid=".9-a0f6">
                                                    Date Posted
                                                </option>
                                                <option value="stipend" data-oid="lxgj6xg">
                                                    Stipend
                                                </option>
                                                <option value="duration" data-oid="qd3q:2c">
                                                    Duration
                                                </option>
                                                <option value="company" data-oid="hqyc:5j">
                                                    Company
                                                </option>
                                            </select>
                                        </div>
                            ...
                            >
                                <div
                                    ...
                                    data-oid="97uv1js"
                                >
                                    <div className="flex items-start gap-4" data-oid="cx4ma5l">
                                        <div
                                        ...
                                        <div data-oid="qzst2:q">
                                            ...
                                            <p className="text-gray-600 text-sm" data-oid="wyrksk4">
                            ...
                            <div className="space-y-6" data-oid="_xyi-fv">
                                {isLoading ? (
                                    <div className="text-center py-16" data-oid="siv2s-l">
                                        <div
                                            className="animate-spin rounded-full h-12 w-12 border-b-2 border-[hsl(196,80%,45%)] mx-auto"
                                            data-oid="5t8_8fj"
                                        ></div>
                                        <p className="mt-4 text-gray-600" data-oid="htxpmnl">
                                            Loading internships...
                                        </p>
                                    </div>
                                    ...
                                    <>
                                        ...
                                        {visibleInternships < filteredInternships.length && (
                                            <div className="text-center py-8" data-oid="28y.na1">
                                                <button
                                    ...
                                    <div className="text-center py-16" data-oid="tu3rdlz">
                                        <div
                                        ...
                                        <p className="text-gray-600 mb-6" data-oid="o8x1moi">
