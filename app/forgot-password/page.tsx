...
export default function ForgotPasswordPage() {
    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 overflow-hidden -z-10" data-oid=":yb-.-f">
                <div
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md px-4 py-8 z-10" data-oid="m_jgbcb">
                <div className="text-center mb-6" data-oid="4_n9vyl">
                    <Link href="/" className="inline-block" data-oid="p40m4iq">
                        <Logo data-oid="xwgetob" />
                    </Link>
                    <h2 className="mt-6 text-3xl font-extrabold text-gray-800" data-oid="h__:4-1">
                        Reset your password
                    </h2>
                    <p className="mt-2 text-sm text-gray-600" data-oid="xiz:v0f">
                ...
                >
                    ...
                    {isSubmitted ? (
                        <div className="text-center" data-oid=":450mjv">
                            <div className="mb-4 flex justify-center" data-oid="yzorvx2">
                                <div
                            ...
                            <h3 className="text-lg font-medium text-gray-900" data-oid="_2q1o:6">
                                Check your email
                            </h3>
                            <p className="mt-2 text-sm text-gray-600" data-oid=".quy7z0">
                                We've sent a password reset link to{' '}
                                <strong data-oid="3j1uw5u">{email}</strong>
                            </p>
                            <p className="mt-4 text-sm text-gray-600" data-oid="0pc3spo">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit} data-oid=":vu7k23">
                            <div data-oid="89_x2s_">
                                <label
                                    htmlFor="email"
                                ...
                                <div className="mt-1 focus-within-scale" data-oid="fzpxqpy">
                                    <input
                                        id="email"
                                        name="email"
                                        type="email"
                ...
                <div className="mt-6 text-center" data-oid="l5uew9:">
                    <p className="text-sm text-gray-600" data-oid="beeat_-">
