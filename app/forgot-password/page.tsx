...
export default function ForgotPasswordPage() {
    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 overflow-hidden -z-10" data-oid=".2ma4-4">
                <div
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md px-4 py-8 z-10" data-oid="ce:7kfc">
                <div className="text-center mb-6" data-oid="osujuj2">
                    <Link href="/" className="inline-block" data-oid="pvwa0w3">
                        <Logo data-oid="nmlifdt" />
                    </Link>
                    <h2 className="mt-6 text-3xl font-extrabold text-gray-800" data-oid="yp..nbn">
                        Reset your password
                    </h2>
                    <p className="mt-2 text-sm text-gray-600" data-oid="_omnubq">
                ...
                >
                    ...
                    {isSubmitted ? (
                        <div className="text-center" data-oid="3lx1i9e">
                            <div className="mb-4 flex justify-center" data-oid="1cpnd0s">
                                <div
                            ...
                            <h3 className="text-lg font-medium text-gray-900" data-oid="wroefbb">
                                Check your email
                            </h3>
                            <p className="mt-2 text-sm text-gray-600" data-oid="u7ntjko">
                                We've sent a password reset link to{' '}
                                <strong data-oid="3sm-xpi">{email}</strong>
                            </p>
                            <p className="mt-4 text-sm text-gray-600" data-oid="o8g:mb:">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit} data-oid="5nwud7g">
                            <div data-oid="4mxihpb">
                                <label
                                    htmlFor="email"
                                ...
                                <div className="mt-1 focus-within-scale" data-oid="fzz9hpl">
                                    <input
                                        id="email"
                                        name="email"
                                        type="email"
                ...
                <div className="mt-6 text-center" data-oid="4sjn9h1">
                    <p className="text-sm text-gray-600" data-oid="-x3q-nq">
