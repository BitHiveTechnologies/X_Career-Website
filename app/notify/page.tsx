                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="grid md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-400 mb-4">Empowering tech freshers with the right opportunities, tools, and guidance to get hired faster.</p>
                            <div className="flex space-x-4">
                                ...
                                <a href="https://t.me/x_careers" className="text-gray-400 hover:text-white transition-all duration-300" target="_blank" rel="noopener noreferrer">
