    ...
    return (
        <>
            ...
            >
                ...
                <div className="fixed inset-0 overflow-hidden -z-10" data-oid="_m_1m5y">
                    <div
                ...
                <div className="w-full sm:mx-auto sm:max-w-md z-10 -mt-20" data-oid="cdm427_">
                    <div className="text-center mb-6" data-oid="erh_60y">
                        <h2 className=" text-3xl font-extrabold text-gray-800" data-oid="-ulhvq2">
                            Welcome back
                        </h2>
                        <p className="mt-2 text-sm text-gray-600" data-oid="vv:e8n3">
                    ...
                    >
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit} data-oid="qln891g">
                            <div data-oid="pp9-gi1">
                                <label
                                    htmlFor="email"
                                ...
                                <div className="mt-1" data-oid="8m.7y3j">
                                    <input
                                        id="email"
                                        name="email"
                                        type="email"
                            ...
                            <div data-oid="_yyg0qo">
                                ...
                                <div className="mt-1" data-oid="8azwhqw">
                                    <input
                                        id="password"
                                        name="password"
                                        type="password"
                            ...
                            <div className="flex items-center justify-between" data-oid="hho5i.5">
                                <div className="flex items-center" data-oid="g:2pmma">
                                    <input
                                        id="remember-me"
                                        name="remember-me"
                                        type="checkbox"
                                ...
                                <div className="text-sm" data-oid="tvln:40">
                                    <Link
                    ...
                    <div className="mt-6 text-center" data-oid="w.np236">
                        <p className="text-sm text-gray-600" data-oid="vom8mbr">
